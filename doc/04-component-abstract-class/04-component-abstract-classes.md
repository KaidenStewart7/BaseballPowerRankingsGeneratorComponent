...
The only change I made was that I added the following methods to the Kernel:
- `int baseballPowerRankingsGeneratorSize()`
- `int baseballPowerRankingsGeneratorTeamSize()`

These methods will be used to check the preconditions needed in some of the secondary methods.
