...
For my representation I decided to use a two dimensional array of Strings, and two int variables. The two dimensional array of String will be the easiest and most efficient way to hold the data as I the number of elements to be held will not change. The two ints will hold the lowest and highest point differentials in the league which will be important in the calculation of the strength ratings.
