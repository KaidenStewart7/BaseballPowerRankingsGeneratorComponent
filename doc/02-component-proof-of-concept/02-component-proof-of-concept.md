...
I have decided to go with my Baseball Power Rankings idea. I ruled out the Random Baseball Player Generator to make a guessing game to guess MLB players because there is already a very similar game to it. I also ruled out the Table creater because using excel would probably be better than using the Table creater component when tables are needed. The Baseball Power Rankings component could potentially be very useful as not only could it be used to rank teams, but it could potentially be used to predict the winner of games. In 2021 I did a very similar thing for College Football, however instead of using some some of program to get the rankings I did it hall by hand via excel. This became a very tedious process, so much so I only did it for the last week of the season before bowl season. However being able to automate most of the process would be worthwile because for bowl season I correctly picked 68% percent of the games correctly. This may not sound like a drastic number, but given the fact that upsets occur regularly in college football and bowl games are supposed to be roughly even match ups, 68% is pretty good. Even more importantnly the rankings picked all of the College Footabll Playoff games correctly and all but one of the New Year Six bowls correctly. Also something to note; the one incorrect pick was for a team who had their quarterback injured early in the game. So why would I pick to create a component for the MLB instead of College Football if I already created a formula I could automate for college football? For starters, college football is my second favorite sport to watch and Major League Baseball is my favorite sport to watch. And secondly, the start of the Major League Baseball season coincides nicely with the time frame of this project. I could benefit by the timing of this project by being able to create an automated power rankings calculator to produce power rankings every week or so to see how teams stack up against each other. Futhermore, it will be interested to see how the power rankings correlate to being able to predict the winners of different games.
